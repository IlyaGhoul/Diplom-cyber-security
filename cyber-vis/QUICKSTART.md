...
Перед развёртыванием на сервер рекомендуется протестировать локально.
...
## 4️⃣ Готово, можно деплоить!

После тестирования локально → следуйте [DEPLOYMENT_DOCKER.md](../DEPLOYMENT_DOCKER.md) или разделу в README.
