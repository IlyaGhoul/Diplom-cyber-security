...
Использование: python update_api_urls.py https://your-server.com "D:\\path\\to\\site"
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Использование: python update_api_urls.py <API_URL> \"D:\\path\\to\\site\"")
        print("Пример: python update_api_urls.py https://api.example.com \"D:\\site\"")
        sys.exit(1)
